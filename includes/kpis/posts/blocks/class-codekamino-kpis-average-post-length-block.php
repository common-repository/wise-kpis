...
/**
 * Class Codekamino_Kpis_Average_Post_Length_Block.
 *
 * Implements Codekamino_Kpis_Kpi_Block_Interface to calculate the average length of posts.
 */
if ( ! class_exists( 'Codekamino_Kpis_Average_Post_Length_Block' ) ) :
	class Codekamino_Kpis_Average_Post_Length_Block implements Codekamino_Kpis_Kpi_Block_Interface {
		...
		/**
		 * Constructs a new Codekamino_Kpis_Average_Post_Length_Block object.
		 *
		...
		public function get_name(): string {
			return __( 'Average Post Length', 'wise-kpis');
		}
		...
		public function get_description(): string {
			return __( 'The average length of posts across all post types.', 'wise-kpis');
		}
