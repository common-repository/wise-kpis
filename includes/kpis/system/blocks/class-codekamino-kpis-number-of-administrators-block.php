...
if ( ! class_exists( 'Codekamino_Kpis_Number_Of_Administrators_Block' ) ) :
	class Codekamino_Kpis_Number_Of_Administrators_Block implements Codekamino_Kpis_Kpi_Block_Interface {
		...
		/**
		 * Constructs a new Codekamino_Kpis_Number_Of_Administrators_Block object.
		 *
		...
		public function get_name(): string {
			return __( 'Number of Administrators', 'wise-kpis');
		}
		...
		public function get_description(): string {
			return __( 'The total number of administrators on the site.', 'wise-kpis');
		}
