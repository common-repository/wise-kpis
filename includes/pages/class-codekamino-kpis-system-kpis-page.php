...
if ( ! class_exists( 'Codekamino_Kpis_System_Kpis_Page' ) ) :
	class Codekamino_Kpis_System_Kpis_Page {
		public static function render() {
			...
			$kpi_blocks_iterator = new Codekamino_Kpis_Blocks_Iterator( $wpdb, 'kpis/system/blocks', $query_timeframe );
			...
			<div class="wrap">
				...
				<?php endif; ?>
				<h1 class="text-3xl font-bold mb-8"><?php _e( 'System KPIs', 'wise-kpis' ); ?></h1>
