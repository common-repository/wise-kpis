...
if ( ! class_exists( 'Codekamino_Kpis_Posts_Kpis_Page' ) ) :
	class Codekamino_Kpis_Posts_Kpis_Page {
		public static function render() {
			...
			$kpi_blocks_iterator = new Codekamino_Kpis_Blocks_Iterator( $wpdb, 'kpis/posts/blocks', $query_timeframe );
			...
			<div class="wrap">
				...
				<?php endif; ?>
				<h1 class="text-3xl font-bold mb-8"><?php _e( 'Posts KPIs', 'wise-kpis' ); ?></h1>
					...
					<form method="POST">
						...
						<div class="mb-4 text-xl">
							...
							if ( empty( $frameObject->start_date ) ) {
								?>
								<span class="text-gray-600"><?php _e( 'Selected Date <b>Today</b>', 'wise-kpis' ); ?></span>
